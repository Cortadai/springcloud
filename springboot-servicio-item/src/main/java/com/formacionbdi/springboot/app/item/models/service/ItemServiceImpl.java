...
import com.formacionbdi.springboot.app.commons.entity.models.Producto;
...
public class ItemServiceImpl implements ItemService{
	...
	public List<Item> findAll() {
		List<Producto> productos = Arrays.asList(clienteRest.getForObject("http://servio-productos/listar", Producto[].class));
	...
	public Producto save(Producto producto) {
		...
		ResponseEntity<Producto> response = 
				clienteRest.exchange("http://servicio-productos/crear", 
